...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" method="POST" action="{{ route('availability.update', $availabilityData->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group mb-2 mb-md-3 row">
                            ...
                            <input type="text" value="{{$availabilityData->jam_kerja}}" class="mb-3 form-control col-3"
                                name="jam_kerja" id="jam_kerja" required>
                            ...
                            <input type="text" class="form-control col-3 mt-3" id="total_downtime" name="total_downtime"
                                readonly>
                        ...
                        <div class="mt-5 d-flex justify-content-between">
                            ...
                            <div>
                                <form action="{{ route('availability.update', $availabilityData->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn btn-primary ml-2" id="button-simpan"
                                        >Update</button>
                                </form>
                                <a href="{{ route('performance.detail', $availabilityData->id) }}" class="btn btn-success ml-2"
